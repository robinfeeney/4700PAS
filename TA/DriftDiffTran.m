...
Simulation = 'PNJctEqBiasCopy';
% Simulation = 'GaussianTwoCarRCLinGrad';

if strcmp(Simulation,'Gaussian2Car')
...
elseif strcmp(Simulation,'Gaussian2CarCopy')
    eval('SetGaussian2CarParasCopy');
elseif strcmp(Simulation,'PNJctEqBiasCopy')
    eval('SetPNJctParasEqBCBiasCopy');
end
